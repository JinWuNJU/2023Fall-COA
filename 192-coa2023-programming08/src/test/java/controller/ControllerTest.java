...
public class ControllerTest {
    ...
    public void testIndirect(){
        ...
        byte[] data = {
                (byte) 0b11101100, 0b00110000, 0b00000000,      0b00000001, // lui r3,4096
                (byte) 0b11011100, 0b00110000, 0b00000001,(byte)0b10000000, // addc r3,
        };
        memory.write("00000000000000000000000000000000",8,data);
        ...
        assertEquals("00000000000000000000000010000000",String.valueOf(controller.getGPR(3)));
    }
    ...
    public void testMixed(){
        ...
        byte[] data = {
                ...
                (byte) 0b11000000, 0b01010100, 0b01000000,(byte)0b00000000, // lw r5,r4,0
                (byte) 0b11001110, 0b00000000, 0b00000000,(byte)0b00000001, // ecall
