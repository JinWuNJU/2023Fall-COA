...
public class Disk {
    ...
    private static class DiskHead {
        ...
        public void seek(int start) {
            int cal_start = start % (8 * 1024 * 1024);
            this.track = cal_start / (64 * 512);
            this.sector = (cal_start - this.track * 64 * 256) / 512;
            this.point = (this.sector * 512) % 512;
        }
        ...
        public void addPoint() {
            if(this.point + 1 <= 511){
                this.point += 1;
            }else if(this.sector + 1 <= 63){
                this.point = 0;
                this.sector += 1;
            }else if(this.track + 1 <= 255){
                this.point = 0;
                this.sector = 0;
                this.track += 1;
            }else {
